...
*/
    ...
    pythia.readString("PhaseSpace:pTHatMin = 40.0");
...
*/
  ...
  // Process Level.  
    ...
    char ch2[1024];
    ifstream f1("file1.in");
    if(!f1.is_open()){
    	cout<<"Error opening file1.in!\n";
    }
    else{
    	f1.getline(ch2, 1024);
    	seed+=ch2;
...
///////////////////////////////////////////////////////
   ...
   ofstream partoninfor("./outputdatafile/pythia_infor.dat");
   
   ofstream gammainfor("./outputdatafile/gamma.dat");
   ofstream numparton("./outputdatafile/numpt.dat");
   ofstream partonrecombine("./outputdatafile/parton.dat");   
   ofstream crosscheck("./outputdatafile/check.dat");
...
//////////////////////////////////////////////
		...
		if(ndrphoton==0 || ptgamma<80.0 || ptgamma>1000.0 || abs(etagamma)<0.0 || abs(etagamma)>1.44) continue;			
...
//////////////////////////////////////////////
        ...
        double event_weight=pythia.info.sigmaGen();
		
		int ID_trigger=event[IDgamma].id();		
		
        gammainfor<<numEvent<<" "<<event_weight<<" "<<ID_trigger<<" "<<P1gamma<<" "<<P2gamma<<" "<<P3gamma<<" "<<P0gamma<<endl;		
...
crosscheck<<setw(24)<<numEvent<<setw(24)<<event[i].id()<<setw(24)<<event[i].px()<<setw(24)<<event[i].py()<<setw(24)<<event[i].pz()<<setw(24)<<event[i].e()<<setw(24)<<VX<<setw(24)<<VY<<setw(24)<<VZ<<setw(12)<<tishower<<setw(24)<<Q0<<endl;



       partonrecombine<<setw(12)<<numEvent<<"  "<<setw(12)<<event[i].id()<<"  "<<setw(12)<<event_weight<<"  "<<setw(12)<<event[i].px()<<"  "<<setw(12)<<event[i].py()<<"  "<<setw(12)<<event[i].pz()<<"  "<<setw(12)<<event[i].e()<<"  "<<setw(12)<<ishower<<"  "<<setw(12)<<VX<<"  "<<setw(12)<<VY<<"  "<<setw(12)<<VZ<<"  "<<setw(12)<<tishower<<endl;
...
//        partonrecombine<<numEvent<<"  "<<event[i].id()<<"  "<<event[i].px()<<"  "<<event[i].py()<<"  "<<event[i].pz()<<"  "<<event[i].e()<<"  "<<VX<<"  "<<VY<<"  "<<VZ<<"  "<<tishower<<endl;
	...
	numparton<<numEvent<<"  "<<njetparton<<" "<<event_weight<<endl;	
