...
//                }                 
		...
		if(abs(KATT1[i])==4){ // write out heavy quark
                    if(heavyOut==1) outHQ << KATT1[i] << "    " << P[1][i] << "    " << P[2][i] << "    " << P[3][i] << "    " << P[0][i] << "    " << P[4][i] << "    " << Vfrozen[1][i] << "    " << Vfrozen[2][i] << "    " << Vfrozen[3][i] << "    " << Vfrozen[0][i] << "    " << Tfrozen[i] << "    " << vcfrozen[1][i] << "    " << vcfrozen[2][i] << "    " << vcfrozen[3][i] << "    " << P[5][i] << "    " << P[6][i] << endl;
                } 
