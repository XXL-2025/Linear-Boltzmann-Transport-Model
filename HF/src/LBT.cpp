...
//cout<<"V0:"<<V0[1][i]<<V0[1][2]<<V0[3][i]<<endl;
...
VX00=Vx_cal(VX00,zcar0,VZ00);
              ...
              //   cout << "test1" << VX00 << VY00 << VZ00 << endl;
	      ...
	      free0=0;
              ...
              if(bulkFlag==1) { // read OSU hydro
                 ...
                 VY00=Vy_cal(VY00,zcar0,VZ00);
                 VZ00=Vz_cal(zcar0,VZ00);
               //  cout << "test2" << VX00 << VY00 << VZ00 << endl;
...
//cout<<"ti"<<ti<<endl;
//cout<<"i:"<<i<<"  "<<"type:"<<KATT1[i]<<endl;
//cout<<"position"<<V[1][i]<<" "<<V[2][i]<<" "<<V[3][i]<<endl;
cout<<"momentum"<<P[0][i]<<"  "<<P[1][i]<<"  "<<P[2][i]<<"  "<<P[3][i]<<endl;
cout << "mass:" << sqrt(P[0][i] * P[0][i] - P[1][i] * P[1][i] - P[2][i] * P[2][i] - P[3][i] * P[3][i]) << endl;
...
//xx-25-12-25
                      ...
                      bulklinear(tau,xxx,yyy,eta, temp0, VX, VY, VZ, hydro_ctl);
                      //xx-25-12-25



                      //bulklinear(tcar, xcar, ycar, zcar, temp0, VX, VY, VZ, hydro_ctl);  //我注释的
                      cout << "bulklinear:" << endl;
                      cout << tau<<"  " << xxx << "  " << yyy << "  " << eta << "  " << temp0 << "  " << VX << "  " << VY << "  " << VZ << "  " << hydro_ctl << endl;
...
//              Kfactor=KPfactor*KTfactor*KTfactor*preKT*preKT;      
              ...
              cout << "KPamp:" << KPamp << "  " << "PLen:" << PLen << "  " << "KPsig:" << KPsig << endl;
              cout << "KTamp:" << KTamp << "  " << "temp0:" << temp0 << "  " << "hydro_Tc:" << hydro_Tc << "  " << "KTsig:" << KTsig << endl;
              cout << "KPfactor:" << KPfactor  << "  " << "preKT:" << preKT << endl;
...
// get radiation probablity by reading tables -- same for heavy and light partons
             ...
             // cout << "nHQgluon:" << nHQgluon(KATT1[i], dt_lrf, Tdiff, temp0, E, maxFncHQ) << endl;
              cout << "KTfactor:" << KTfactor << "  " << "runKT:" << runKT << endl;
	//	cout<<"444444"<<endl;
		
	     // cout<<"radng:"<<radng[i]<<endl;
	     // cout<<"-------------"<<endl;
	      }
...
//CAT!!!			  //xx-25-12-12  np0是对新粒子的处理，忽略即可
/*	       				
*/
                          CAT[np0]=2;
