...
//              cout << firstStr << "     " << secondStr << endl;
              if(secondStr=="=") {
                  ...
                  else if(firstStr=="flag:flagPNP") flagPNP=atof(divideChar[2]);
                  else if(firstStr=="para:scaleSigma") scaleSigma=atof(divideChar[2]);
...
// write out parameters
       ...
       cout << "flag:flagPNP: " << flagPNP << endl;
       cout << "para:scaleSigma: " << scaleSigma << endl;
       cout << "############################################################" << endl;
       cout << endl;
