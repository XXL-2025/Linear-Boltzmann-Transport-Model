...
int       flagPNP=1;     // 0 Yukawa only, 1 string only, 2 Both
double    scaleSigma = 4.0;    // scale factor for sigma parameter in string potential
...
double striRHQ[60][20];        //total scattering rate for heavy quark
double striRHQ11[60][20];      //Qq->Qq
double striRHQ12[60][20];      //Qg->Qg

double qhatHQ[60][20];     //qhat of heavy quark

double striqhatHQ[60][20];     //qhat of heavy quark
...
/////////////////////////////////////////////////////////////////
double stridistFncB[N_T][N_p1][N_e2],stridistFncF[N_T][N_p1][N_e2],stridistMaxB[N_T][N_p1][N_e2],stridistMaxF[N_T][N_p1][N_e2];
double stridistFncBM[N_T][N_p1],stridistFncFM[N_T][N_p1];
double min_p1=0.0;
...
const double cs=0.04;
const double cb=1.3;
double msprime;
double mdprime;
double massflag=1.27;   ////1.27 for c; 4.19 for b
...
const double qstart=0.0;
const double Tdelta=0.01;
const double qdelta=0.01;
double A2q[mmax][maxMC]={0.0};
