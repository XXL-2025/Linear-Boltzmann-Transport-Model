...
double LBTclass::nHQgluonXX(int parID, double dtLRF, double& time_gluon, double& temp_med, double& HQenergy, double& max_Ng) {
	...
	time_num = (int)(time_gluon / delta_tg + 0.5) + 1;   //xx-12-7 ��ȫһ��
	...
	if (temp_num >= temp_gn) temp_num = temp_gn - 1;//25-12-7 ����һ��temp_gnXX��������ֵ��ͬ�����ĸ���һ��
